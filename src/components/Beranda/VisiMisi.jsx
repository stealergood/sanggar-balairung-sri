...
export const VisiMisi = () => {
  return (
    <div className="w-full h-[800px] md:h-[1024px] bg-motif-android3 md:bg-motif3 bg-cover bg-center">
      <div className="w-full flex justify-center py-20">
        <h1 className="font-blenda text-primary text-4xl lg:text-6xl">Visi & Misi</h1>
      </div>
      <div className="w-full flex flex-col lg:flex-row lg:flex-wrap gap-6 justify-between px-6 lg:px-20 pb-10">
        ...
        <div className="w-full lg:w-[48%] lg:order-1 flex flex-col gap-6">
          <div>
            ...
            <ul className="text-black list-disc list-inside text-base text-justify mt-3">
