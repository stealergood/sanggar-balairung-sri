    ...
    <div className="w-full h-[800px] md:h-[1024px] bg-motif-android3 md:bg-motif3 bg-cover bg-center overflow-y-scroll">
      ...
      <div className="w-full px-6 lg:px-20 pb-10 flex flex-col gap-3">
        ...
        <div className="w-full text-black flex flex-col gap-3 text-justify">
          ...
          <p className="text-[12px] md:text-base indent-6">
          ...
          <div className="flex gap-10 text-[10px] md:text-base pt-5">
            <div className="w-52 flex flex-col text-wrap text-center gap-2">
              <img
                src={Alat1}
                alt=""
                className="w-52 md:h-[200px] rounded-[1.9rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
              />
              <h2>cara memegang alat musik gambus</h2>
            </div>
            <div className="w-52 flex flex-col text-center gap-2">
              <img
                src={Alat2}
                alt=""
                className="w-52 md:h-[200px] rounded-[1.9rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
              />
              <h2>Alat Musik Gambus</h2>
            </div>
          </div>
        </div>
        ...
        <div className="w-full text-black flex flex-col gap-3 text-justify">
          ...
          <p className="text-[12px] md:text-base indent-6 block md:hidden">
            ...
            Melayu tradisional, seperti Zapin.
          </p>
          <p className="text-[12px] md:text-base indent-6 block md:hidden">
            Marwas memiliki beberapa karakteristik, seperti instrumen drum
            sederhana, ritme ritme, dan elemen dinamis yang mendukung musik
            tradisional dan ritme. Pengaruhnya meluas ke era Zapin Siak,
            menyediakan energi dan ritme untuk waktu dan ruang. Marwas juga
            memiliki pengaruh dari era Timur Tengah, terutama musik Arab, yang
            dipengaruhi oleh Islam dan dianggap musik Melayu. Marwas digunakan
            dalam festival musik tradisional dan perayaan di Siak untuk
            mempromosikan dan mempertahankan warisan musik Melayu. Ini tidak
            hanya menyediakan hiburan tetapi juga mempromosikan identitas dan
            harmoni komunitas. Untuk menghindari salah pemahaman dan pengertian,
            diberilah istilah kata-kata”tak dan tung”. Kata “tak” bermakna
            memukul bagian tepi marwas, sedangkan “tung” adalah memukul bagian
            tengahnya. Selain itu tak tung juga memiliki makna tinggi dan
            rendah, dimana dalam kaidah permusikan (notasi) nada tinggi
            dinyatakan dengan not yang tarangkai keatas, dan nada rendah not
            tangkainya kebawah.
          </p>

          <p className="text-[12px] md:text-base indent-6 hidden md:block">
            Marwas (meruas) berasal dari kata “seruas”. Kata serua hanya
            terdapat pada jenis kayu-kayuan dan bambu. Menurut kamus umum bahasa
            Indonesia, kata ruas ini adalah bagian antara buku dengan denga
            buku. (Poerwadarminta, 1976: 834). Marwas adalah bentuk musik
          ...
          <div className="flex flex-col md:flex-row gap-5 md:gap-10 py-5 items-center">
            <img
              src={Alat5}
              alt=""
              className="w-48 rounded-[1.6rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
            />
            <img
              src={Alat6}
              alt=""
          ...
          <ul className="list-decimal px-5 flex flex-col gap-5 text-[12px] md:text-base">
            <li>
              ...
              <div className="py-5">
                <img
                  src={Alat7}
                  alt=""
                  className=" w-60 rounded-[1.3rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
                />
              </div>
            </li>
            <li>
              ...
              <div className="py-5">
                <img
                  src={Alat8}
                  alt=""
                  className="w-60 rounded-[1.9rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
                />
              </div>
            </li>
            <li>
          ...
          <div className="w-full flex justify-center md:justify-start pt-10 pb-5">
            <div className="w-52 flex flex-col flex-wrap justify-center text-center gap-2 text-[12px] md:text-base">
              <img
                src={Alat3}
                alt=""
                className="w-52 rounded-[1.8rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
              />
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[12px] md:text-base indent-6 block md:hidden md:indent-0">
              Selain teknik pukulan, aturan dan posisi serta kedudukan marwas
              juga harus dipelajari dengan baik. Cara memegang marwas adalah
              dengan meletakkan marwas tersebut diatas tangan kiri dengan posisi
              yang tepat, dimana marwas berada di telapak tangan dengan ibu jari
            ...
            <p className="text-[12px] md:text-base indent-6 block md:hidden md:indent-0">
              Permainan jari manis, tengah dan telunjuk yang berada di sisi
              bawah tersebut menutup dan membuka menurut istilah tak tung.
              Sekain itu keakraban dan kerjasama antara jari-jari yang berada
              pada tangan kiri harus seimbang dengan jari-jari sebelah kanan.
              Keseimbangan inilah yang harus dijaga agar refleksinya tetap
              berjalan terus dengan lancar, sehingga harmonisasinya dapat
              dirasakan. Setelah tiga pukulan dasar, selanjutnyaa akan
              diketengahkan perkembangan pukulannya sesuai dengan dasar
              pembagianya. Misalnya pukul satu dipecah menjadi tiga pukulan dan
              seterusnya. Untuk lebih jelasnya lihatlah partitur dibawah :
            </p>

            <p className="text-[12px] md:text-base indent-6 md:block hidden">
              Ada istilah lanjutan atau tingkat pukulan yang harus dikuasai,
              istilah tersebut adalah “senting” atau “dogoh”. Kedua istilah ini
              berguna sebagai pukulan menaik (keras, nyaring dan melengking).
              Dalam bahasa istilah musik senting dan dogoh ini disebut “forte”
            ...
            <p className="text-[12px] md:text-base indent-6 md:block hidden md:indent-0">
              Selain teknik pukulan, aturan dan posisi serta kedudukan marwas
              juga harus dipelajari dengan baik. Cara memegang marwas adalah
              dengan meletakkan marwas tersebut diatas tangan kiri dengan posisi
              yang tepat, dimana marwas berada di telapak tangan dengan ibu jari
            ...
            <div className="py-5">
              <img
                src={Alat4}
                alt=""
                className="w-72 rounded-[1.2rem] shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
              />
            </div>
          </div>
          <p className="mt-10 text-[12px] md:text-base">
            Untuk lebih jelas simaklah partitur komposisi musik zapin berikut :
          </p>
          <div className="w-full flex flex-col justify-center gap-10">
            <div className="w-full flex flex-col items-center text-[12px] md:text-base">
              <p>Bismillah</p>
            ...
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-10">
              <div className="w-fit flex flex-col text-center gap-2 text-[12px] md:text-base">
                <img
                  src={Nada1}
                  alt=""
                  className="w-[25rem] rounded-2xl shadow-[-1px_-1px_20px_9px_rgba(0,0,0,0.54)]"
                />
                <p>Note 1</p>
              </div>
              <div className="w-fit flex flex-col text-center gap-2 text-[12px] md:text-base">
