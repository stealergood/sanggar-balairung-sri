    ...
    <div className="w-full h-[52rem] bg-motif2 bg-cover bg-center overflow-y-scroll">
      ...
      <div className="w-full px-6 text-sm md:px-10 text-black pb-10 text-justify">
        <p>
          ...
          zapin yang ada. Ini disebabkan oleh fakta bahwa tari zapin tidak
          memiliki pola urutan gerak atau bunga zapin yang telah ditetapkan.
          Pola ini ditentukan oleh fakta bahwa kedua penari laki-laki secara
          bersamaan memutuskan gerak atau bunga zapin mana yang akan dilakukan
          lagi setelah mereka menari zapin. Selama gerak atau bunga zapin ini
          belum diputuskan, kedua penari harus membawakan langkah biasa atau
          langkah satu sampai delapan berulang kali. Dalam menampilkan tari
        ...
        <ul className="list-[lower-alpha] mt-3 px-5">
          ...
          <li>
            ...
            Jari setengah menggenggam
          </li>
          <li>Tangan kanan bebas bergerak mengikuti irama dan gerakan tubuh</li>
          <li>
            Melangkah dengan sedikit guncangan atau hentakan pada bagian badan
            atau pinggang, sambil lutut ditekukkan.
          </li>
          <li>Melangkah maju naik, boleh sedikit menyerong</li>
          <li>Angkat kaki tidak terlalu tinggi</li>
          <li>
            Gerakan kepala mengikuti gerak badan, lutut dan lenggang atau ayunan
            langkah
          </li>
          <li>Penari berdua berdampingan dengan jarak tidak terlalu rapat</li>
          <li>Pemusik dan penari berpakaian melayu</li>
          <li>
            Penari dapat bermain dengan langkah dan geraknya dalam berzapin
          </li>
